$(function(){
	...
	function editHandler(){
		...
		var opt_td = $('<td></td>');
		var saveButton = $(" <button class="btn btn-secondary radius" ><a href='javascript:;' class='optLink'><i class="Hui-iconfont">&#xe632;</i> 保存&nbsp;</a></button>");
	...
	function create_row(data_item){
		...
		var delButton = $('<button class="btn btn-danger radius" ><a class="optLink" href="javascript:;"><i class="Hui-iconfont">&#xe6e2;</i>删除&nbsp;</a></button>');
	...
	$("#addBtn").click(function(){
		...
		var confirmBtn = $("<a href='javascript:;' class='optLink'>保存&nbsp;</a>");
