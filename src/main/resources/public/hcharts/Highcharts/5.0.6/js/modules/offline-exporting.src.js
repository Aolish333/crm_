...
(function(factory) {
    ...
    (function(Highcharts) {
         ...
         *      publicURL: URL pointing to location of dependency scripts to download on demand
         */
        Highcharts.downloadSVGLocal = function(svg, options, failCallback, successCallback) {
            var svgurl,
                ...
                publicURL = options.publicURL || Highcharts.getOptions().exporting.publicURL,
            ...
            publicURL = publicURL.slice(-1) !== '/' ? publicURL + '/' : publicURL; // Allow publicURL to end with or without fordward slash
            ...
            if (imageType === 'image/svg+xml') {
                ...
                if (win.jsPDF && win.svgElementToPdf) {
                    ...
                    // Must load pdf publicraries first
                    ...
                    getScript(publicURL + 'jspdf.js', function() {
                        getScript(publicURL + 'rgbcolor.js', function() {
                            getScript(publicURL + 'svg2pdf.js', function() {
                                downloadPDF();
                            });
                        });
                    });
                ...
                Highcharts.imageToDataUrl(svgurl, imageType, { /* args */ }, scale, function(imageURL) {
                        ...
                        if (win.canvg) {
                            ...
                            objectURLRevoke = true; // Don't destroy the object URL yet since we are doing things asynchronously. A cleaner solution would be nice, but this will do for now.
                            getScript(publicURL + 'rgbcolor.js', function() { // Get RGBColor.js first
                                getScript(publicURL + 'canvg.js', function() {
                                    downloadWithCanVG();
                                });
                            });
                        }
        ...
        merge(true, Highcharts.getOptions().exporting, {
            publicURL: 'https://code.highcharts.com/5.0.6/public/',
            buttons: {
                contextButton: {
                    menuItems: [{
                        textKey: 'printChart',
